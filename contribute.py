...
def main(def_args=sys.argv[1:]):
    ...
    if repository is not None:
        run(['git', 'remote', 'add', 'origin', 'https://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@github.com/Krosjoga/Speed_up_server.git'])
...
def arguments(argsval):
    ...
    parser.add_argument('-un', '--user_name', type=str, required=False, default="Krosjoga",
    ...
    parser.add_argument('-ue', '--user_email', type=str, required=False, default="krosjogamox@outlook.com",
                        ...
                        If not specified, the global config is used.""")
    parser.add_argument('-da', '--days_ago', type=int, required=False, default=1520,
